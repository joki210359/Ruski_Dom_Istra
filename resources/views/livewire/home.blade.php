  ...
  <header class="md:hidden sticky top-0 bg-white">
    <div class="grid grid-cols-12 gap-2 items-center">
      <div class="col-span-3">
        <img src="{{ asset('assets/Ruski dom Istra logo.png') }}" class="h-5 max-w-lg w-full" alt="Ruski dom Istra logo.png">
      </div>
  ...
  <main class="grid lg:grid-cols-12 gap-8 md:mt-10">
        ...
        <ul class="flex overflow-x-auto scrollbar-hide items-center gap-2">
          @for ($i = 0; $i < 10; $i++)
            <li class="flex flex-col justify-center w-20 gap-1 p-2">
              <x-avatar story src="{{ asset('profiles/' . $i . '.jpg') }}" class="h-14 w-14" />
    ...
    <aside class="lg:col-span-4 hidden lg:block p-4">
      ...
      <section class="mt-10">
          ...
          <li class="text-xs text-gray-800/90 font-medium"><a href="#" class="hover:underline">Конфиденциальность</a></li>
        ...
        <h3 style="margin-left: 40px;"class="text-gray-800/90 mt-6 text-sm"> &copy; 2024 Русский Дом "Истрия" <br><p style="margin-left: 40px;">Все права защищены</p> <p style="margin-left: 20px;">Designed by Dusan Jovanovic</p></h3>
      </section>
    </aside>
  </main>
