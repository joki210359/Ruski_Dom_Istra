...
<head>
    ...
    <style>
        ...
        .Login .Login-button {
            ...
            text-shadow: 10px -10px 10px #d5bae8;
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl1 font-semibold text-black dark:text-white">
                                        ...
                                        <div class="note">
                                            <!-- It's prohibited to post posts with political messages and views, as well as
                                            posts
                                            encouraging
                                            religious,
                                            racial and national intolerance!!! -->
                                            {{ __('welcome.rules.prohibited') }}
                                        </div>
                                        </p>
                                    </div>
                                </div>
                    ...
                    dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]" style="height: 160px;">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">
                                    <!-- What's new -->
                                    {{ __('welcome.whats_new.title') }}

                                </h2>

                                <h3>
                                    <!-- What's new in Istria -->
                                    {{ __('welcome.whats_new.see') }}
                                </h3>
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <div class="features-div">
                                    ...
                                    <p>
                                        ...
                                        {{ __('welcome.follow.your_interests') }}

                                    </p>

                                    <p>
                                        <!-- Listen to what people are talking about.. -->
                                        {{ __('welcome.follow.listen_to_what_people') }}
                                    </p>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    <section class="bg-red-100 p-0 mb-1">
                        <div class="flex items-center justify-center">
                            <h3 class="text-gray-800/90 mt-4 text-sm text-center">
