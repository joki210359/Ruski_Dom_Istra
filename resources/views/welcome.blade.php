        ...
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                <div class="flex lg:justify-center lg:col-start-2">
                    ...
                    <img src="{{asset('assets/Ruski dom Istra logo.png')}}"
                         class="rounded-md px-4 py-4" width="530px" alt="Ruski dom Istra logo.png">
...
"
                        ...
                        <div class="relative flex items-center gap-6 lg:items-end">
                            <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                ...
                                <div class="pt-3 sm:pt-5 lg:pt-0">
                                    <h2 class="text-xl1 font-semibold text-black dark:text-white">Предупреждение</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                    <div class="note">
                                        Запрещено размещать посты с политическими посланиями и взглядами, а также посты,
                                        поощряющие
                                        религиозную,
                    ...
                    <a
                    <a class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800
