<div
    ...
    <div class="pt-3">
        ...
        <img  x-cloak x-show="!(shrink ||drawer)" src="{{asset('assets/Ruski dom Istra logo.png')}}" class="h-10 w-64 text-black" alt="Ruski dom Istra logo.png">
    </div>
    ...
    <ul class="space-y-4 mt-2">
        ...
        <li><a href="/" class="flex items-center gap-5 ">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-extrabold">Домой</h4>
            </a></li>
        ...
        <li><a class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-medium">Поиск</h4>
            </a></li>
        ...
        <li><a class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-medium">Исследовать</h4>
            </a></li>
        ...
        <li><a class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-medium">Катушка</h4>
            </a></li>
        ...
        <li><a class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-medium">Сообщения</h4>
            </a></li>
 ...
 onclick="Livewire.dispatch('openModal', { component: 'post.create' })"
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-medium">Создать публикацию</h4>
            </div></li>
        ...
        <li><a class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"  class=" text-lg font-medium">Профиль</h4>
            </a></li>
    ...
    <footer class="sticky bottom-0 mt-auto w-full grid px-3 z-50 bg-white">
        <div class="dropdown dropdown-top ">
            <label tabindex="0" class=" cursor-pointer bg-white  flex items-center w-full gap-5 m-1">
                ...
                <h3 x-cloak x-show="!(shrink||drawer)"  class="text-lg font-medium">Более</h3>
            </label>
            <ul tabindex="0" class="dropdown-content z-[1] menu p-2 space-y-3 shadow bg-base-100 rounded-box w-60">
                ...
                <li><a class="py-2">Настройки</a></li>
                <li><a class="py-2">
